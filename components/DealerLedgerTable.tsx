        ...
        <tbody className="border">
          <div className="card-body mt-5">
            <div className="row">
              <div className="col-sm-6">
                <h3 className="mb-0 bold">{dealerledger?.data?.party_name}</h3>
              </div>
          ...
          <div className="table-responsive">
            ...
            >
              <thead>
                <tr>
                  <th className="text-nowrap ledger-table-header">Date</th>
                  <th className="text-nowrap ledger-table-header">
                    Particulars
                  </th>
                  <th className="text-nowrap ledger-table-header">Vch Type</th>
