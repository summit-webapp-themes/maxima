          ...
          <div className="banner-product col-xl-3 col-md-4 mb-4 mb-md-0">
            <div className="banner banner-fixed overlay-zoom br-xs">
              <figure className="banner-media h-100 displaytag-container">
                <Image
                  src={data?.tag_name==="Special Offer"?"/assets/images/specialOffer.png":data?.tag_name==="Best Seller"?"/assets/images/bestseller.png":data?.tag_name==="New Arrival"?"/assets/images/newarrival.png":""}
                  alt="Product Banner"
                  width="431"
                  height="800"
                />
                ...
                <>
                  {data?.value?.length > 0 &&
                    data?.value?.map((list: any, i: any) => (
                      <div
                        className="border mx-2 mt-5 displaytag-list"
                        key={i}
                      >
