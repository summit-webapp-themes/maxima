...
const Index = ({ sales_order_id }: any) => {
  ...
  const myLoadernew = ({ src, width, quality }: any) => {
    return `http://staging-sportnetwork.ascratech.com/uploads/brands/original/${src}?w=${width}&q=${quality || 75
      }`;
  };
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="page_heading">
                <h5
                  className="bold text-uppercase black mb-2 mt-8 orderDetail-heading"
                >
                  order details
                </h5>
              </div>
