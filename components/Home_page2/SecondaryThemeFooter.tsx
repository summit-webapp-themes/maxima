            ...
            <div className="row mt-1">
              ...
              <div className="col-lg-2 col-sm-6">
                <div className="widget">
                  <h3 className="widget-title secondaryTheme-footerTitle">Company</h3>
              ...
              <div className="col-lg-2 col-sm-6">
                <div className="widget">
                  <h4 className="widget-title secondaryTheme-footerTitle">My Account</h4>
                  <ul className="widget-body">
                    <li>
              ...
              <div className="col-lg-2 col-sm-6">
                <div className="widget">
                  <h4 className="widget-title secondaryTheme-footerTitle">Customer Service</h4>
                  <ul className="widget-body">
                    <li>
                      <Link href="#" legacyBehavior>
                        <a>Payment Methods</a>
...
export default SecondaryThemeFooter;
