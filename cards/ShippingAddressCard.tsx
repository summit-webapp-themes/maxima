...
const ShippingAddressCard = ({
  ...
  console.log("shippingAddresses in ship card",shippingAddresses,initialShippingAddress)
          ...
          ?.map((detail: any) => (
            ...
            >
              ...
              <div className="">
                <button
                  type="button"
                  onChange={() => setInitialBillingAddress(detail?.address_id)}
                  onClick={() => setInitialShippingAddress(detail?.address_id)}
                  className={
                    shippingAddresses &&
